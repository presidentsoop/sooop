...
export default async function CertificatePage() {
    ...
    return (
        <div className="flex flex-col items-center py-10 fade-in-up px-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">My Membership Certificate</h1>
            <p className="text-gray-500 mb-8 text-center max-w-md">
                Official SOOOP Certificate of Membership. Valid proof of professional standing.
            </p>

            <MembershipCertificate profile={serializedProfile} />
        </div>
    );
}
