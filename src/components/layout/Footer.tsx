                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-sm">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <a href="tel:+923124043773" className="text-primary-100 hover:text-white">
                                    +92-312-4043773
                                </a>
                            </div>
                            <div className="flex items-center gap-3">
                                ...
                                <a href="mailto:info@sooopvision.com" className="text-primary-100 hover:text-white">
                                    info@sooopvision.com
                                </a>
                            </div>
                        </div>
                    </div>
